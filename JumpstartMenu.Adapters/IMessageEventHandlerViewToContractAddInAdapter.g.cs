...
namespace JumpstartMenu.Adapters
{
    ...
    public class IMessageEventHandlerViewToContractAddInAdapter : System.AddIn.Pipeline.ContractBase, Start9.Api.Contracts.IMessageEventHandlerContract
    {
        ...
        {
            JumpstartMenu.Views.MessageReceivedEventArgs adaptedArgs;
            adaptedArgs = JumpstartMenu.Adapters.MessageReceivedEventArgsAddInAdapter.ContractToViewAdapter(args);
