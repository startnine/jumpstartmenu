...
namespace JumpstartMenu.Adapters
{
    ...
    public class IMessageContractToViewAddInAdapter : JumpstartMenu.Views.IMessage
    {
        ...
        public JumpstartMenu.Views.IMessageEntry MessageEntry
        {
            get
            {
                return JumpstartMenu.Adapters.IMessageEntryAddInAdapter.ContractToViewAdapter(_contract.MessageEntry);
            }
        }
