...
namespace JumpstartMenu.Adapters
{
    ...
    {
        internal static JumpstartMenu.Views.IConfiguration ContractToViewAdapter(Start9.Api.Contracts.IConfigurationContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IConfigurationContract ViewToContractAdapter(JumpstartMenu.Views.IConfiguration view)
        {
            if ((view == null))
            {
                return null;
