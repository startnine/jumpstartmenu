...
namespace JumpstartMenu.Adapters
{
    ...
    {
        internal static JumpstartMenu.Views.MessageReceivedEventArgs ContractToViewAdapter(Start9.Api.Contracts.IMessageReceivedEventArgsContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IMessageReceivedEventArgsContract ViewToContractAdapter(JumpstartMenu.Views.MessageReceivedEventArgs view)
        {
            if ((view == null))
            {
                return null;
