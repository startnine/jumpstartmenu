...
namespace JumpstartMenu.Adapters
{
    ...
    {
        internal static JumpstartMenu.Views.IModuleAssembly ContractToViewAdapter(Start9.Api.Contracts.IModuleAssemblyContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IModuleAssemblyContract ViewToContractAdapter(JumpstartMenu.Views.IModuleAssembly view)
        {
            if ((view == null))
            {
                return null;
